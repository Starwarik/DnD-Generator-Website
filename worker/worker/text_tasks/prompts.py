...
Результат должен быть представлен в формате JSON и включать объект "location" со следующими ключами:  
- "name" — название локации.  
- "description_location" — краткое описание локации в двух предложениях.  
