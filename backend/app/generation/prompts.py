...
npcs_regeneration_prompt = """Сгенерируй {playerNum}-{playerNumXthree} новых персонажей на основе локации. Привяжи к квестам и предметам. Структурируй в объект "character" с ключами: "name" — имя персонажа; "disc_costum" – подробное описание внешности персонажа (до 850 символов);  "dic_life" – описание образа жизни персонажа (до 850 символов)."""

npcs_regeneration_concrete_prompt = """Сгенерируй нового персонажа вместо "{nameCharacter}" на основе локации, с учётом расы, характера и поведения. Привяжи к квесту и предметам. Структурируй в объект "character" с ключами: "name" — имя персонажа; "disc_costum" – подробное описание внешности персонажа (до 850 символов);  "dic_life" – описание образа жизни персонажа (до 850 символов)."""
...
npc_image_generation = """Нарисуй аватар персонажа по имени: «{char_name}» по описанию: 
{char_description}"""
